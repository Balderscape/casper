...
public class IsopointalSetResult implements Comparable<IsopointalSetResult> {
	...
	public double pot_param2;
	public double pot_param3;
	...
	// d. choose structure from the highest space group
	// e. choose lowest site index (i.e. a beats b)
...
//			return 1;
		...
		int diffSG = spaceGroup - o.spaceGroup;
		if (diffSG > 0)
			return -1;
		else if (diffSG < 0)
			return 1;
